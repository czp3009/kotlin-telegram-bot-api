...
class TelegramEventProcessor(
    ...
    companion object {
        private val INCOMING_UPDATE_CONTAINER_ANNOTATION = IncomingUpdateContainer::class
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation(INCOMING_UPDATE_CONTAINER_ANNOTATION.qualifiedName!!)
    ...
    private fun processClassDeclaration(classDecl: KSClassDeclaration) {
        logger.info("Processing @${INCOMING_UPDATE_CONTAINER_ANNOTATION.simpleName} class: ${classDecl.qualifiedName?.asString()}")
    ...
    private fun generateTelegramBotEventsFile(
        ...
        val fileSpec = FileSpec.builder(EVENT_PACKAGE, TELEGRAM_BOT_EVENTS_FILE)
            .indent("    ")
            .addFileComment("Auto-generated by KSP from @${INCOMING_UPDATE_CONTAINER_ANNOTATION.simpleName}, do not modify this file manually")
