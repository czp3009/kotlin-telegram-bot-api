...
public data class InlineKeyboardButton(
     ...
     */
    @SerialName("web_app")
    public val webApp: JsonElement? = null,
    /**
    ...
    public val loginUrl: JsonElement? = null,
    /**
    ...
    public val switchInlineQueryChosenChat: JsonElement? = null,
    /**
     * *Optional*. Description of the button that copies the specified text to the clipboard.
     */
    @SerialName("copy_text")
    public val copyText: JsonElement? = null,
    /**
     * *Optional*. Description of the game that will be launched when the user presses the button.**NOTE:** This type of button **must** always be the first button in the first row.
     */
    @SerialName("callback_game")
    public val callbackGame: JsonElement? = null,
    /**
